...
2026-09-21 보충: 개인 저장소에 팀 프론트 작업물을 반영하고 정적 UI 데모를 GitHub Pages로 공개했습니다. 아래 기존 `PUBLIC_URL: BLOCKED_EXTERNAL`은 **실제 FastAPI·인증·AI 서비스의 공개 URL**에 한합니다. [UI 시연 주소](https://cerhovah.github.io/Codyssey_Mission_B7-1/)는 서버와 연결되지 않는 브라우저 전용 체험이며, 실제 서비스 완료 증거로 간주하지 않습니다.
